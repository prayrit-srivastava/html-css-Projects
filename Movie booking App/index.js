...
seatContEl.forEach((seat) => {
  seat.addEventListener("click", (e) => {
    ...
    updateSeats();
    updatePrice(moviePrice, takenSeats.length);
    const allseat = document.querySelector('#selectedSeatsHolder');
// allseat.textContent = "5";
console.log(allseat.childElementCount);
  },{ once: true });
});
...
const allseat = document.querySelectorAll('#selectedSeatsHolder');
// allseat.textContent = "5";
